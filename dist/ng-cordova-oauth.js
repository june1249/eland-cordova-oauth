        ...
        if($cordovaOauthUtility.isInAppBrowserInstalled()) {
          ...
          browserRef.addEventListener('loadstart', function(event) {
            if((event.url).indexOf(redirect_uri) === 0) {
              ...
              if(parameterMap.access_token !== undefined && parameterMap.access_token !== null) {
                deferred.resolve({ access_token: parameterMap.access_token, expires_in: parameterMap.expires_in, refresh_token: parameterMap.refresh_token, token_type: parameterMap.token_type });
              } else {
                if ((event.url).indexOf("error_code=100") !== 0) {
                  deferred.reject("Facebook returned error_code=100: Invalid permissions");
                } else {
...
(function() {
  ...
  function cordovaOauth(
    ...
    $ngCordovaGoogle, $ngCordovaGithub, $ngCordovaFacebook, $ngCordovaEland, $ngCordovaLinkedin, $ngCordovaInstagram, $ngCordovaBox, $ngCordovaReddit, $ngCordovaSlack,
